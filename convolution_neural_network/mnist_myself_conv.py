...
with tf.Session() as sess:
    ...
    for i in range(1000):
        ...
        print("training batch :"+str(i+1)+" loss is : "+str(loss))
        if((i+1)%40==0):
           print(sess.run(accuracy,feed_dict={input_placeholder:mnist.test.images[:2000],labels_placeholder:mnist.test.labels[:2000]}))
